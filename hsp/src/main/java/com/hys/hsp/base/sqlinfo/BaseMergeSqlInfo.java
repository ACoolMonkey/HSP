 ...
 */
@Slf4j
public abstract class BaseMergeSqlInfo extends AbstractSqlInfo {

    private static final String SPLIT_SQL = "MERGE\\s*INTO(.*)USING(.*)";
    private static final String SPLIT_KEY = "USING";
    ...
    public final boolean splitSql() {
        ...
        log.info("不兼容的merge开头语句匹配");
        return false;
    }

    @Override
    protected SqlInfo getSqlInfoType() {
        return SqlInfo.MERGE;
    }
